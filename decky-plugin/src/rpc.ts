...
export const applyPowerButtonFix = callable<[], FixResult>("apply_power_button_fix");
export const revertPowerButtonFix = callable<[], FixResult>("revert_power_button_fix");
